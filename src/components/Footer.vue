  ...
  >
    ...
    >
      ...
      <div class="flex justify-center">
        <a class="mr-6 text-neutral-600 dark:text-neutral-200" href="#!">
          <svg
            class="h-4 w-4"
            fill="currentColor"
            viewBox="0 0 24 24"
    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div>
          <h6
            class="mb-4 flex justify-center items-center font-semibold uppercase md:justify-start"
          >
            Contacto
          </h6>
          <p class="mb-4 flex items-center justify-center md:justify-start">
            ...
            Av. Libertador, entre Av. Las Acacias y Av. Los Jabillos, Sabana
