    ...
    <section class="mb-32">
      <div class="mb-16 flex flex-wrap">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
          <h2 class="mb-10 text-4xl font-bold">Hotel Vistavila Suites</h2>
          <p class="text-black justify-info">
            En el Hotel Vistavila Suites te ofrecemos instalaciones de primera
            categoría y en una excelente ubicación. Contamos con acogedoras
            habitaciones y estacionamiento privado y, próximamente, pondremos a
            tu disposición nuevos servicios como restaurante con conexión WI-FI,
            todo esto para hacer de tu estadía una experiencia absolutamente
            cómoda y acogedora, sin necesidad de salir de la ciudad, sólo de la
            rutina. Visítanos y disfruta este espacio que hemos creado pensando
            en ti. ¡Te esperamos!
          </p>
        </div>
      </div>
      ...
      <div class="mb-16 flex flex-wrap lg:flex-row-reverse">
        <div
          class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pl-6"
        >
          <div
            class="ripple relative overflow-hidden rounded-lg bg-cover bg-[50%] bg-no-repeat shadow-lg dark:shadow-black/20"
            data-te-ripple-color="light"
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
          ...
          <div
            class="mb-4 flex items-center text-sm font-medium text-primary dark:text-primary-400"
          >
            <svg
              class="mr-2 h-4 w-4"
              fill="none"
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
          ...
          <div
            class="mb-4 flex items-center text-sm font-medium text-yellow-600"
          >
            <svg
              class="mr-2 h-5 w-5"
              fill="none"
          ...
          <p class="text-black">
            ...
            Nullam in commodo sapien. Curabitur ut erat congue sem finibus
            eleifend egestas eu metus. Sed ut dolor id magna rutrum ultrices ut
            eget libero. Duis vel porttitor odio. Ut pulvinar sed turpis ornare
